...
def simplified_cost(x_train, y_train, w, b):
    m = y_train.shape[0]
    cost = 0
...
if __name__ == "__main__":
    ...
    print("If b=-2 (simplified function):", simplified_cost(X_train, y_train, w_tmp, -2))
    print("If b=-3 (simplified function):", simplified_cost(X_train, y_train, w_tmp, -3))
    print("If b=-4 (simplified function):", simplified_cost(X_train, y_train, w_tmp, -4))
